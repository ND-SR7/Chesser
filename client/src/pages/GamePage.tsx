...
const GamePage = ({gameType} : GamePageProps) => {
  ...
  { row: 8, column: "A", color: "aliceblue" }, { row: 8, column: "B", color: "lightblue" }, { row: 8, column: "C", color: "aliceblue" }, { row: 8, column: "D", color: "lightblue" },
  { row: 8, column: "E", color: "aliceblue" }, { row: 8, column: "F", color: "lightblue" }, { row: 8, column: "G", color: "aliceblue" }, { row: 8, column: "H", color: "lightblue" },
  { row: 7, column: "A", color: "lightblue" }, { row: 7, column: "B", color: "aliceblue" }, { row: 7, column: "C", color: "lightblue" }, { row: 7, column: "D", color: "aliceblue" },
  { row: 7, column: "E", color: "lightblue" }, { row: 7, column: "F", color: "aliceblue" }, { row: 7, column: "G", color: "lightblue" }, { row: 7, column: "H", color: "aliceblue" },
  { row: 6, column: "A", color: "aliceblue" }, { row: 6, column: "B", color: "lightblue" }, { row: 6, column: "C", color: "aliceblue" }, { row: 6, column: "D", color: "lightblue" },
  { row: 6, column: "E", color: "aliceblue" }, { row: 6, column: "F", color: "lightblue" }, { row: 6, column: "G", color: "aliceblue" }, { row: 6, column: "H", color: "lightblue" },
  { row: 5, column: "A", color: "lightblue" }, { row: 5, column: "B", color: "aliceblue" }, { row: 5, column: "C", color: "lightblue" }, { row: 5, column: "D", color: "aliceblue" },
  { row: 5, column: "E", color: "lightblue" }, { row: 5, column: "F", color: "aliceblue" }, { row: 5, column: "G", color: "lightblue" }, { row: 5, column: "H", color: "aliceblue" },
  { row: 4, column: "A", color: "aliceblue" }, { row: 4, column: "B", color: "lightblue" }, { row: 4, column: "C", color: "aliceblue" }, { row: 4, column: "D", color: "lightblue" },
  { row: 4, column: "E", color: "aliceblue" }, { row: 4, column: "F", color: "lightblue" }, { row: 4, column: "G", color: "aliceblue" }, { row: 4, column: "H", color: "lightblue" },
  { row: 3, column: "A", color: "lightblue" }, { row: 3, column: "B", color: "aliceblue" }, { row: 3, column: "C", color: "lightblue" }, { row: 3, column: "D", color: "aliceblue" },
  { row: 3, column: "E", color: "lightblue" }, { row: 3, column: "F", color: "aliceblue" }, { row: 3, column: "G", color: "lightblue" }, { row: 3, column: "H", color: "aliceblue" },
  { row: 2, column: "A", color: "aliceblue" }, { row: 2, column: "B", color: "lightblue" }, { row: 2, column: "C", color: "aliceblue" }, { row: 2, column: "D", color: "lightblue" },
  { row: 2, column: "E", color: "aliceblue" }, { row: 2, column: "F", color: "lightblue" }, { row: 2, column: "G", color: "aliceblue" }, { row: 2, column: "H", color: "lightblue" },
  { row: 1, column: "A", color: "lightblue" }, { row: 1, column: "B", color: "aliceblue" }, { row: 1, column: "C", color: "lightblue" }, { row: 1, column: "D", color: "aliceblue" },
  { row: 1, column: "E", color: "lightblue" }, { row: 1, column: "F", color: "aliceblue" }, { row: 1, column: "G", color: "lightblue" }, { row: 1, column: "H", color: "aliceblue" }
]);
